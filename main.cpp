...
int main() {
    ...
    string filename = "C:\\Users\\ytzha\\C++ projects\\hope\\data\\house_data1.csv";
    ...
    while(true) {
        ...
        if(option == 1) {
            ...
            for (const auto& house : houses) {
                ...
                housemap.InsertSquareFeet(house);
            }
        ...
        if(option == 4) {
            ...
            for (const auto& house : houses) {
                ...
                housemap.InsertYearBuilt(house);
            }
        ...
        if(option == 5) {
            ...
            for (const auto& house : houses) {
                ...
                housemap.InsertHousePrice(house);
            }
